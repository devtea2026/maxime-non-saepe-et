# @devtea2026/maxime-non-saepe-et
...
Next, install `@devtea2026/maxime-non-saepe-et`:

```bash
npm install @devtea2026/maxime-non-saepe-et --save-dev
```

**Note:** If you installed ESLint globally (using the `-g` flag) then you must also install `@devtea2026/maxime-non-saepe-et` globally.
